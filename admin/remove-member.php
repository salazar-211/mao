                    ...
                    <div class='widget-content nopadding'>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            echo "<tr>
                                ...
                                <td>".$row['others']."</td>
                                <td><div class='text-center'><a href='actions/delete-member.php?id=".$row['user_id']."' onclick='return confirm(\"Are you sure you want to remove this member?\");' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
                            </tr>";
                            $cnt++;
                        }
